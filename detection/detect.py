...
def main(opt, img=None):
    ...
    det = Detector(weights = "/home/simplyvignesh/conedet/weights/best.pt")
    cap = cv2.VideoCapture(0)
    while True :
    	ret, frame = cap.read()
    	if not ret:
    		break
    	coords, bb_img, confidence = det.run_on_img(frame)
    	print("Coords:", coords)
...
if __name__ == "__main__":
    opt = parse_opt()
    main(opt)
    #img = cv2.imread("/home/simplyvignesh/conedet/images/image2.jpeg")
    #det = Detector(weights = "/home/simplyvignesh/conedet/weights/best.pt")
